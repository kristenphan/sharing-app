...
public class ElasticSearchManager {
    ...
    private static final String SERVER = "192.168.0.101:9200";
    private static final String INDEX = "599860013";
    ...
    /**
     * Returns all remote bids from server -- THIS METHOD IS CALLED IN BidList.getRemoteBids()
     */
    ...
    /**
     * Add bid to remote server -- THIS METHOD IS CALLED IN AddBidTask.execute()
     */
